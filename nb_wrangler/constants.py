...
NBW_MAMBA_CMD = str(
    os.environ.get("NBW_MAMBA_CMD", os.environ.get("MAMBA_EXE", NBW_MAMBA_DEFAULT))
)
...
# Registry defaults
DEFAULT_REGISTRY = os.environ.get("NBW_IMAGE_REGISTRY", "ghcr.io")
DEFAULT_PROJECT = os.environ.get(
    "NBW_IMAGE_PROJECT", "spacetelescope/nb-wrangler-images"
)

# Notebook testing constants
NOTEBOOK_TEST_MAX_SECS = int(
    os.environ.get("NBW_TEST_MAX_SECS", 4 * 60 * 60)
)  # 4 hours
...
DEFAULT_TIMEOUT = 300
REPO_CLONE_TIMEOUT = 7200
DATA_GET_TIMEOUT = 7200
ENV_CREATE_TIMEOUT = 1800
INSTALL_PACKAGES_TIMEOUT = 3600
PIP_COMPILE_TIMEOUT = 1200
IMPORT_TEST_TIMEOUT = 120
